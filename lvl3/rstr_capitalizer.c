...
//el mio funcinando, muy parecido al de abajo, solo que no contorlo los \t, cuiado ahi en el examen
...
{
    int i = 1; //importante inicializar el i a 1 para no printar el "a.out"
